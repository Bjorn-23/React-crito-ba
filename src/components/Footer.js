  ...
  return (
    <footer className="footer">
        <div className="footer-top relative-f-t">
            <div className="top container">
                <div className="grid-container">
                    <div id="logotype" className="grid-item">
                        <a href="index.html"><img src="images/footer/Logo-cs.svg"
                                alt="The logotype of Crito Consulting INC" /></a>
                    ...
                    <div className="grid-item">
                        ...
                        <div className="grey-text">
                            <p><a href="#l">Customer Support</a></p>
            ...
            <div className="design"><img className=" absolute-f-t" src="images/footer/design-squiggles.svg"
        ...
        <div className="footer-bottom">
            <div className="bottom container relative">
                ...
                <div className="right">
                    <p><a className="soc-med-footer" href="https://facebook.com" target="_blank"><i
                                className="fa-brands fa-facebook"></i></a></p>
                    <p><a className="soc-med-footer" href="https://twitter.com" target="_blank"><i
                                className="fa-brands fa-x-twitter"></i></a></p>
                    <p><a className="soc-med-footer" href="https://instagram.com" target="_blank"><i
                                className="fa-brands fa-instagram"></i></a></p>
                    <p><a className="soc-med-footer" href="https://linkedin.com" target="_blank"><i
